...
export const Headers: { [key: string]: string } = {
  ...
  'Cache-Control': 'Used to specify directives that must be obeyed by all caching mechanisms along the '
        + 'request-response chain.',
  Connection: 'Control options for the current connection and list of hop-by-hop request fields. Must not be used '
        + 'with HTTP/2.',
