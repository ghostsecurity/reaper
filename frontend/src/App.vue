...
<template>
  ...
  <div class="fixed pt-1 w-10 bg-polar-night-1a h-full">
    ...
    <button :class="'text-snow-storm-1 hover:bg-polar-night-3 p-1 rounded '+(sidebar === 'workspace' ? 'bg-polar-night-4' : '')" @click="setSidebar('workspace')">
  ...
  <div class="flex-1 w-3/4">
   <Dashboard :criteria="criteria" :onCriteriaChange="onCriteriaChange" :proxy-address="'127.0.0.1:' + settings.ProxyPort"/>
  </div>
  </div>
