          ...
          <TransitionChild
            ...
            <DialogPanel
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                ...
                <button
                    type="button"
                    class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-offset-2 dark:bg-gray-500 dark:text-snow-storm-1 sm:mt-0 sm:w-auto sm:text-sm"
                    @click="emit('cancel')"
                    ref="cancelButtonRef">
                  {{ cancel }}
                </button>
