...
function setProxyPort(event: any) {
                ...
                <div class="py-6 px-4 sm:p-6 lg:pb-8">
                  ...
                  <ul role="list" class="mt-2 divide-y divide-gray-200">
                    <SwitchGroup as="li" class="flex items-center justify-between py-4">
                      ...
                      <Switch @update:modelValue="setDarkMode" v-model="modifiedSettings.DarkMode"
                        :class="[modifiedSettings.DarkMode ? 'bg-frost' : 'bg-aurora-1', 'relative ml-4 inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out']">
                        <span aria-hidden="true"
                          :class="[modifiedSettings.DarkMode ? 'translate-x-5' : 'translate-x-0', 'inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                      </Switch>
                    </SwitchGroup>
                  </ul>
                </div>
              ...
              <div :class="{ 'hidden': 'certs' !== openTab }">
                <div class="py-6 px-4 sm:p-6 lg:pb-8">
                  ...
                  <div class="mt-2 divide-y divide-gray-200">
                    <div class="flex flex-col">
                      <button @click="exportCA" type="button"
                        class="inline-flex items-center rounded border border-transparent bg-frost px-2.5 py-1.5 text-xs font-medium text-snow-storm-3 shadow-sm hover:bg-frost-2 focus:outline-none">
                        Export CA
                      </button>
                    </div>
                  </div>
