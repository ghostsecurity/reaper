...
<template>
  <div class="mt-2 mb-6 border border-polar-night-4 rounded-md p-2">
    ...
    <button @click="addRule" class="mt-2 inline-flex items-center rounded-md border border-transparent bg-aurora-4
     px-3 py-2 text-sm font-medium leading-4 text-white shadow-sm hover:bg-aurora-5 focus:outline-none focus:ring-2
