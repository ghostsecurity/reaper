...
export default /*#__PURE__*/ defineComponent({
  ...
  emits: ['save-request', 'unsave-request'],
  methods: {
...
import {MagnifyingGlassCircleIcon, StarIcon} from "@heroicons/vue/20/solid";
