  ...
  <div>
      ...
      <div class="mt-8">
        ...
        <div class="relative mt-1 rounded-md shadow-sm">
          <input v-model="simpleDomains" @blur="saveSimple" type="text" name="domains" id="domains"
                 ...
                 aria-invalid="true" aria-describedby="domains-error"/>
        </div>
      </div>
      <div class="mt-8">
    ...
    <div v-else>
      ...
      <p class="text-sm text-gray-400">A request will be included in scope if ANY <strong><i>include</i></strong> rule
        matches. A request will be excluded if ANY <strong><i>exclude</i></strong> rule matches. <strong><i>Exclude</i></strong>
        rules override <strong><i>include</i></strong> rules.</p>
